...
/obj/item/weapon/hand_labeler
   icon = 'icons/Uristqwerty/food_processor_placeholder.dmi' //this stuff probably isn't current for bs12
   icon_state = "labeler"
   item_state = "flight"
   name = "Hand labeler"
...
/obj/item/weapon/label
   icon = 'icons/Uristqwerty/food_processor_placeholder.dmi' //I used the fingerprinted fingerprint card for this, I'm sure someone will be willing to come up with something better
