...
/obj/machinery/shielding/energyconverter/proc/UpdateIcon()
	...
	if (stat)
		...
		if(OperatingMode && Capacitor && !Capacitor.stat)
			addoverlay(image('icons/Uristqwerty/food_processor_placeholder.dmi', "o[round((ConversionRate * 11) / HardMaximumConversionRate)]"))
		else
			addoverlay(image('icons/Uristqwerty/food_processor_placeholder.dmi', "econ-o"))