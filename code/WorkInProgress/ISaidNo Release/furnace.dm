/obj/machinery/power/furnace
	...
	process()
		...
		src.overlays = null
		if (src.active) src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "furn-burn")
		if (fuelperc >= 20) src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "furn-c1")
		if (fuelperc >= 40) src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "furn-c2")
		if (fuelperc >= 60) src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "furn-c3")
		if (fuelperc >= 80) src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "furn-c4")
