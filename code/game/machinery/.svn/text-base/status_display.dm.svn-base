...
/obj/machinery/status_display
	...
	proc/set_picture(var/state)
		picture_state = state
		overlays = null
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', icon_state=picture_state)
	...
	proc/texticon(var/tn, var/px = 0, var/py = 0)
		var/image/I = image('icons/Uristqwerty/food_processor_placeholder.dmi', "blank")
		...
		for(var/d = 1 to len)
			...
			var/image/ID = image('icons/Uristqwerty/food_processor_placeholder.dmi', icon_state=char)
