...
/obj/machinery/portable_atmospherics/canister/update_icon()
	...
	if (src.destroyed)
		...
		icon_state = "[colour]"
		if(holding)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "can-oT")

		var/tank_pressure = air_contents.return_pressure()

		if (tank_pressure < 10)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "can-o0")
		else if (tank_pressure < ONE_ATMOSPHERE)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "can-o1")
		else if (tank_pressure < 15*ONE_ATMOSPHERE)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "can-o2")
		else
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "can-o3")
	return
