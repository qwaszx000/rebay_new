...
/obj/item/weapon/firstaid_arm_assembly
	...
	New()
		...
		spawn(5)
			if(src.skin)
				src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "kit_skin_[src.skin]")
...
/obj/machinery/bot/medbot/New()
	...
	spawn(4)
		if(src.skin)
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "medskin_[src.skin]")
...
/obj/item/weapon/firstaid_arm_assembly/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if ((istype(W, /obj/item/device/healthanalyzer)) && (!src.build_step))
		...
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "na_scanner")
		del(W)
