...
/obj/machinery/filter_control/proc/updateicon()
	...
	if(src.locked && (stat & BROKEN))
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control00")
		return
	else if(!src.locked)
		icon_state = "filter_control-unlocked"
		if(stat & BROKEN)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control-wirecut")
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control00")
			return
	...
	if(GoodConnection && src.f_mask)
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control1")
	else if(GoodConnection)
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control10")
	else if(src.f_mask)
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control0")
	else
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control00")

	if (src.f_mask & (GAS_N2O|GAS_PL))
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control-tox")
	if (src.f_mask & GAS_O2)
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control-o2")
	if (src.f_mask & GAS_N2)
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control-n2")
	if (src.f_mask & GAS_CO2)
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter_control-co2")
	return
