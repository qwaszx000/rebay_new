...
/obj/machinery/pipes/proc/update()
	...
	if(node1 && node2)
		...
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "discon", FLY_LAYER, dirs[1])
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "discon", FLY_LAYER, dirs[2])
	else if(!node1)
