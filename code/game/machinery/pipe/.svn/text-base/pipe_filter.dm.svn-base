...
/obj/machinery/pipefilter/attackby(obj/item/weapon/W, mob/user as mob)
	...
	if(istype(W, /obj/item/weapon/card/emag) && (!emagged))
		...
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-spark")
...
/obj/machinery/pipefilter/proc/updateicon()
	...
	if(stat & NOPOWER)
		...
		if(emagged)	//only show if powered because presumeably its the interface that has been fried
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-emag")
		if (src.f_mask & (GAS_N2O|GAS_PL))
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-tox")
		if (src.f_mask & GAS_O2)
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-o2")
		if (src.f_mask & GAS_N2)
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-n2")
		if (src.f_mask & GAS_CO2)
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-co2")
	if(!locked)
		src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-open")
		if(bypassed)	//should only be bypassed if unlocked
			src.overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "filter-bypass")