...
//end of equippable shit
	...
	mymob.throw_icon.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	mymob.throw_icon.icon_state = "act_throw_off"
	mymob.throw_icon.name = "throw"
	mymob.throw_icon.screen_loc = ui_throw

	mymob.oxygen = new /obj/screen( null )
	mymob.oxygen.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.fire.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	mymob.fire.icon_state = "fire0"
	mymob.fire.name = "fire"
	mymob.fire.screen_loc = ui_fire

	mymob.healths = new /obj/screen( null )
	mymob.healths.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	mymob.healths.icon_state = "health0"
	mymob.healths.name = "health"
	mymob.healths.screen_loc = ui_health

	mymob.pullin = new /obj/screen( null )
	mymob.pullin.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	mymob.pullin.icon_state = "pull0"
	mymob.pullin.name = "pull"
	mymob.pullin.screen_loc = ui_pull

	mymob.blind = new /obj/screen( null )
	mymob.blind.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.flash.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.hands.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.sleep.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	mymob.sleep.icon_state = "sleep0"
	mymob.sleep.name = "sleep"
	mymob.sleep.screen_loc = ui_sleep

	mymob.rest = new /obj/screen( null )
	mymob.rest.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
