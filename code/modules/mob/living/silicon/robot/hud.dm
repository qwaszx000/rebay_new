/obj/hud/proc/robot_hud()
	...
	mymob.module_icon.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.panel_icon.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.cell_icon.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.exttemp.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
	...
	mymob.store.icon = 'icons/Uristqwerty/food_processor_placeholder.dmi'
