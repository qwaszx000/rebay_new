...
/obj/machinery/power/apc/proc/updateicon()
	...
	if(opened)
		...
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "apcox-[locked]")	// 0=blue 1=red
		overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "apco3-[charging]") // 0=red, 1=yellow/black 2=green


		if(operating)
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "apco0-[equipment]")	// 0=red, 1=green, 2=blue
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "apco1-[lighting]")
			overlays += image('icons/Uristqwerty/food_processor_placeholder.dmi', "apco2-[environ]")
